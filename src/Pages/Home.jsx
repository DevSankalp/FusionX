...
function Home() {
  const siteData = {
    ...
    heroData: {
      ...
      subtitle: "Innovate, Collaborate, Succeed with FusionX",
      description:
        "We help startups turn their ideas into reality and scale their business through our incubation program. We provide access to a vast network of investors, industry experts, and mentors. Our aim is to create a supportive ecosystem that enables startups to thrive in a competitive market.",
    },
    aboutData: {
      heading: "Why Choose FusionX",
      subHeading:
        "FusionX is the perfect platform for startups looking to grow and succeed. Our platform offers a range of benefits, including:",
      section1: {
        Image: [image1, image2],
        title: "Expert Mentorship",
        description:
          "Our team of expert mentors provides startups with the guidance and support they need to navigate the challenging world of entrepreneurship.",
        paragraph:
          "Whether you need help with product development, marketing, or fundraising, our mentors are here to help.",
      },
      section2: {
        Image: [image3, image4],
        title: "Funding Opportunities",
        description:
          "We provide startups with access to a range of funding opportunities, including angel investors, venture capitalists, and government grants.",
        paragraph: [
      ...
      section3: {
        ...
        description:
          "Our platform offers a range of training and educational resources to help startups learn and grow. From online courses to workshops and seminars, we provide startups with the knowledge and skills they need to succeed.",
        paragraph: [
          "Online Courses",
    ...
    featuresData: {
      title: "Features",
      subtitle:
        "FusionX offers a range of features designed to help startups grow and succeed. Our platform includes:",
      description:
        "From mentorship and funding to training and education, FusionX provides startups with everything they need to succeed.",
      image1Src: image7,
      image2Src: image8,
    },
    feedbackData: {
    ...
    footerData: {
      logoText: "FusionX",
      menuItems: {
        items: ["Home", "Listings", "Forum", "FXCareers"],
      ...
      <div className="bg-white">
        ...
        >
          <ParallaxBannerLayer
            ...
            style={{ inset: "120px 0" }}
          >
            <Feedback feedbackData={siteData.feedbackData} />
          </ParallaxBannerLayer>
        </ParallaxBanner>
